...
public class DesertSides extends JFrame {
	...
	private JLabel lblChocLavaCake;
	private JLabel lblBlueberryCheesecake;
	private JLabel lblOnionRings;
	private JLabel lblPotatoWedges;
	private JLabel back;
	...
	public DesertSides() {
		...
		btnDessertSide.setEnabled(false);
		...
		lblChocLavaCake = new JLabel("");
		Image img = new ImageIcon(this.getClass().getResource("/ChocolateLavaCake.png")).getImage();
		Image newImage = img.getScaledInstance(109, 85, Image.SCALE_DEFAULT);
		lblChocLavaCake.setIcon(new ImageIcon(newImage));
		lblChocLavaCake.setBounds(44, 26, 109, 85);
		panel_1.add(lblChocLavaCake);
		
		lblBlueberryCheesecake = new JLabel("");
		Image img1 = new ImageIcon(this.getClass().getResource("/blueberryCheesecake.png")).getImage();
		Image newImage1 = img1.getScaledInstance(109, 85, Image.SCALE_DEFAULT);
		lblBlueberryCheesecake.setIcon(new ImageIcon(newImage1));
		lblBlueberryCheesecake.setBounds(44, 118, 109, 85);
		panel_1.add(lblBlueberryCheesecake);
		
		lblOnionRings = new JLabel("");
		Image img2 = new ImageIcon(this.getClass().getResource("/onionRing.png")).getImage();
		Image newImage2 = img2.getScaledInstance(109, 85, Image.SCALE_DEFAULT);
		lblOnionRings.setIcon(new ImageIcon(newImage2));
		lblOnionRings.setBounds(44, 212, 109, 85);
		panel_1.add(lblOnionRings);
		
		lblPotatoWedges = new JLabel("");
		Image img3 = new ImageIcon(this.getClass().getResource("/potatoWedges.png")).getImage();
		Image newImage3 = img3.getScaledInstance(109, 85, Image.SCALE_DEFAULT);
		lblPotatoWedges.setIcon(new ImageIcon(newImage3));
		lblPotatoWedges.setBounds(316, 26, 109, 85);
		panel_1.add(lblPotatoWedges);
		...
		panel_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
		        ...
		        String ingredients = "Dark Chocolate, Vanilla extract, Powdered sugar";
		...
		lblCheese = new JLabel("Chocolate Lava Cake");
		lblCheese.setFont(new Font("Tahoma", Font.BOLD, 10));
		panel_2.add(lblCheese);
		
		lblPrice = new JLabel("Price: 8,000krw");
		lblPrice.setFont(new Font("Tahoma", Font.BOLD, 10));
		panel_2.add(lblPrice);
		
		lblCalories = new JLabel("300 calories per serving");
		...
		panel_3.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				// Display ingredients as a message dialog
		        String ingredients = "Cream cheese, Graham cracker crust, Blueberries, Sugar";
		        JOptionPane.showMessageDialog(panel_2, "Ingredients Used:\n" + ingredients);
			}
		});
		...
		lblPepperoniPizza_1 = new JLabel("Blueberry Cheesecake");
		lblPepperoniPizza_1.setFont(new Font("Tahoma", Font.BOLD, 10));
		panel_3.add(lblPepperoniPizza_1);
		
		lblPricekrw = new JLabel("Price: 9,000krw");
		...
		panel_4.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				// Display ingredients as a message dialog
		        String ingredients = "Onions, Seasonings, Egg wash, Oil";
		        JOptionPane.showMessageDialog(panel_2, "Ingredients Used:\n" + ingredients);
			}
		});
		...
		panel_5.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				// Display ingredients as a message dialog
		        String ingredients = "Potatoes, Seasonings, Herbs, Olive Oil";
		        JOptionPane.showMessageDialog(panel_2, "Ingredients Used:\n" + ingredients);
			}
		});
